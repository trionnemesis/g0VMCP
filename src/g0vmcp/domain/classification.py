...
# --------------------------------------------------------------------------
# 採用「CPC 碼 2 碼前綴 → 領域」對照。真實採購網標的分類碼為 CPC 制
# (Central Product Classification),非先前虛構的 31/32。涵蓋 IT / 工程 / 醫療 /
# 清潔 / 其他。對照基準:
#   45 計算機及週邊設備、84 電腦及相關服務、47 通訊器材 → IT
#   41/42 工程相關;51/52 醫療相關;71/72 清潔相關。
